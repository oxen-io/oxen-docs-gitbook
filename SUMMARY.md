...
* [🖥️ Service Node guides](using-the-oxen-blockchain/oxen-service-node-guides/README.md)
  ...
  * [⛴️ Migrating to the new Session Network](using-the-oxen-blockchain/oxen-service-node-guides/migrating-to-the-new-session-network/README.md)
    * [✅ Migration Checklist](using-the-oxen-blockchain/oxen-service-node-guides/migrating-to-the-new-session-network/migration-checklist.md)
    * [🔗 Connecting to an Arbitrum One RPC Endpoint](using-the-oxen-blockchain/oxen-service-node-guides/migrating-to-the-new-session-network/connecting-to-an-arbitrum-one-rpc-endpoint.md)
    * [🔀 How to set up an oxend L2 proxy](using-the-oxen-blockchain/oxen-service-node-guides/migrating-to-the-new-session-network/how-to-set-up-an-oxend-l2-proxy.md)
